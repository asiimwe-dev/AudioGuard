...
class AppConstants {
  ...
  // Audio Configuration
  static const List<String> supportedAudioFormats = ['wav', 'mp3', 'm4a', 'ogg'];
  ...
  // TFLite Model
  static const String tfliteModelPath = 'assets/models/watermark_detector.tflite';
  ...
  // Error Messages
  static const String errorNoInternet = 'No internet connection. Using local mode.';
  ...
  static const String errorMessageTooLong = 'Message exceeds 256 character limit.';
  static const String errorApiUnreachable = 'API server is unreachable.';
  static const String errorTfliteModelNotLoaded = 'TFLite model failed to load.';
  static const String errorUnknown = 'An unexpected error occurred.';
  
  // Success Messages
  static const String successEncodingComplete = 'Watermark embedded successfully.';
  static const String successDecodingComplete = 'Watermark extracted successfully.';
  static const String successVerificationPassed = 'Watermark verification passed.';
